...
class DecisionInputs:
    ...
    deferred_findings_tracking_complete: bool = True  # compatibility name: issue-required dispositions only
...
def assess_decisions(inputs: DecisionInputs) -> DecisionResult:
    ...
    if not inputs.deferred_findings_tracking_complete:
        hard_blockers.append("one or more issue-required finding dispositions lack equivalent open GitHub issues")
